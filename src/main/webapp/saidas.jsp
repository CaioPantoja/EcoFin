  ...
  <div class="container mt-4 mb-5">
    ...
    <div class="entry-card position-relative">
      ...
      <div class="entry-item">
        <span class="entry-label">Condomínio:</span><br>
        R$ 1.000,00 <span class="float-end">Data 12/08/2024</span>
        <i class="fas fa-pen float-end me-2"></i>
      </div>
      <div class="entry-item">
        <span class="entry-label">Condomínio:</span><br>
        R$ 1.000,00 <span class="float-end">Data 10/07/2024</span>
        <i class="fas fa-pen float-end me-2"></i>
      </div>
      <div class="entry-item border-0">
        <span class="entry-label">Netflix:</span><br>
        R$ 50,00 <span class="float-end">Data 07/07/2024</span>
        <i class="fas fa-pen float-end me-2"></i>
      </div>
    </div>
  </div>
