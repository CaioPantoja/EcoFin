        ...
        <div class="container">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Form de cadastro -->
              <form id="transactionForm" action="${pageContext.request.contextPath}/entradas" method="post"
                class="d-none mb-4">
              ...
              <!-- Título da tabela -->
              <h3 class="transaction-title">Lista de Entradas</h3>
